# Generated by Django 4.1.1 on 2023-02-10 12:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(verbose_name='Date Of Assessment')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('assessment_score', models.FloatField(blank=True, default=0, null=True, verbose_name='Score')),
            ],
        ),
        migrations.CreateModel(
            name='Course',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_score', models.FloatField(help_text='Adds All Assessments For the Current Semester')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='schoolapp.course')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='students_assessed', to='schoolapp.student'),
        ),
        migrations.AddField(
            model_name='assessment',
            name='score',
            field=models.ForeignKey(blank=True, default=0, null=True, on_delete=django.db.models.deletion.CASCADE, to='schoolapp.assessmentscore'),
        ),
        migrations.AddField(
            model_name='assessment',
            name='semester',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='schoolapp.semester'),
        ),
        migrations.CreateModel(
            name='Announcement',
            fields=[
